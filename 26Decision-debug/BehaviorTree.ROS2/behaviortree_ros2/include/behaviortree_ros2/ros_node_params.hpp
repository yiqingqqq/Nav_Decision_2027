...
struct RosNodeParams
{
  ...
  // QoS used by topic publisher wrappers. Keep the existing depth-1 default,
  // while allowing individual BT plugins to request transient-local delivery.
  rclcpp::QoS publisher_qos = rclcpp::QoS(1);
