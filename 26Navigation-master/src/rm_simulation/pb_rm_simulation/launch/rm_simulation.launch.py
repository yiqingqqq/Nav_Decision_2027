...
def get_world_config(world_type):
    world_configs = {
        ...
        WorldType.RMUL2027: {
            ...
            'z': '0.10',
            'yaw': '3.14159',
            'world_path': 'RMUL2027_world/RMUL2027_world.world'
        }
    }
...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=WorldType.RMUL2027,
        description='Choose <RMUC>, <RMUL>, <RMUL2026H>, or <RMUL2027>'
    )
    ...
    bringup_RMUL2026H_cmd_group = create_gazebo_launch_group(WorldType.RMUL2026H)#thth
    bringup_RMUL2027_cmd_group = create_gazebo_launch_group(WorldType.RMUL2027)
    ...
    ld.add_action(bringup_RMUL2027_cmd_group) # type: ignore
