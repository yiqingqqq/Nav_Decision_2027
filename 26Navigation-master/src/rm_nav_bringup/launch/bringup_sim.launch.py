...
def generate_launch_description():
    ...
    slam_toolbox_posegraph_dir = PathJoinSubstitution([rm_nav_bringup_dir, 'map', world])#++++
    ...
    nav_to_pose_bt_xml = os.path.join(
        rm_nav_bringup_dir, 'config', 'navigate_to_pose_with_controller_selector.xml')
            ...
            Node(
                ...
                parameters=[
                    ...
                    {'use_sim_time': use_sim_time,
                     ...
                     'pose_graph_filename': slam_toolbox_posegraph_dir,#++++
